...
const projects = [
	{
		...
		tags: ['javascript', 'reactjs', 'sanity.io', 'css'],
		description:
			'A Front End application build in JavaScript and React for ACM MVSR Student Chapter. This application uses Sanity.io as a headless CMS.',
	},
	{
		...
		description:
			'A NodeJS E-Commerce application which does all the basic crud operations along with authentication and authorization.',
	},
	{
